...
export default function Navbar() {
  ...
  return (
    <Container>
      <nav className="text-white max-w-7xl mx-auto py-3 px-4 lg:rounded-2xl flex items-center justify-between  fixed bg-primary/20 backdrop-blur-3xl top-0 left-0 right-0 z-50 ">
        <Logo />
